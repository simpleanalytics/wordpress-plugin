=== Simple Analytics ===
Contributors: Adriaan van Rossum
...
You need to have a paid subscription from Simple Analytics (https://simpleanalytics.com).

== Installation ==

Installing "Simple Analytics" can be done by using the following steps:
